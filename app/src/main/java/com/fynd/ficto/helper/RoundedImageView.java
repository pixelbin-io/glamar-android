...
/**
 * Created by vineetkhuswha on 15/03/16.
 */
...
//            ((VectorDrawable) drawable).draw(canvas);
      ...
      /*  Bitmap bitmap =null;
        if (drawable instanceof VectorDrawable){
            bitmap =  ((BitmapDrawable) ((VectorDrawable) drawable).getCurrent()).getBitmap();
        }
        else
            bitmap =  ((BitmapDrawable) drawable).getBitmap();//b.copy(Bitmap.Config.ARGB_8888, true);
