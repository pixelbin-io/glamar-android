package com.fynd.ficto.customRecycleView;
...
import com.fynd.ficto.transform.DiscreteScrollItemTransformer;
...
class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    public boolean canScrollHorizontally() {
        return sharedpreferences.getBoolean(ScrollKey,true);
